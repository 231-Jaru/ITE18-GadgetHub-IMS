            ...
            <form @submit.prevent="handleSubmit">
              <div class="mb-4">
                <label for="categoryName" class="block text-sm font-semibold text-gray-700 mb-2">
                  <i class="fas fa-tag mr-2 text-indigo-600"></i>Category Name
                </label>
                <input 
                  type="text" 
                  ...
                  placeholder="Enter category name (e.g., Smartphone, Laptop, Tablet)" 
                  required
                >
              </div>
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                >
                  ...
                  <i v-else class="fas fa-save mr-2"></i>Add Category
                </button>
              </div>
            </form>
          </div>
...
const handleSubmit = async () => {
  try {
    ...
    if (err.data?.errors) {
      ...
      error.value = err.data?.message || err.message || 'Failed to create category. Please try again.'
    }
  } finally {
